...
class Assignment(DatabaseObject):
    _table = DatabaseTable(
        table = 'assignment',
        columns = [ 'create_time',
                    'target_id',
...
class Hashcat(DatabaseObject):
    _table = DatabaseTable(
        table = 'hashcat',
        columns = [ 'create_time',
                    'global_wordlist_index',
                    'global_brutforce_last',
                    'global_wordlist_count',
                    'global_wordlist_path',
                    'global_rules_path',
                    'global_rules_count',
                    'global_rules_index',
                    'global_hashes_path',
...
class Hashcat_Host(DatabaseObject):
    _table = DatabaseTable(
        table = 'hashcat_host',
        columns = [ 'hostid',
                    'hashcatid',
                    'speed',
                    'workload_profile',
                    'sent_rules_index_start',
                    'sent_rules_index_stop',
                    'sent_words_index_stop',
                    'sent_words_index_stop'
                    ])
...
class Word(DatabaseObject):
    _table = DatabaseTable(
        table = 'hashcat_word',
        columns = [ 'word'
                    ])

class Charset_hex(DatabaseObject):
    _table = DatabaseTable(
        table = 'hashcat_charset_hex',
        columns = [ 'charset_hex'
                    ])
...
Assignments  = Assignment._table
Hashcats     = Hashcat._table
Hashes       = Hash._table
Rules        = Rule._table
Words        = Word._table
Charsets_hex = Charset_hex._table
Hashcat_Hosts= Hashcat_Host._table
