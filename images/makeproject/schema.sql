...
create table hashcat (
    id                      integer         not null auto_increment,
    create_time             integer         not null,
    global_wordlist_index   integer         not null default 0,
    global_bruteforce_last  varchar(254),
    global_wordlist_count   integer         not null default 0,
    global_wordlist_path    varchar(254),
    global_rules_count      integer         not null default 0,
    global_rules_path       varchar(254),
    global_hashes_path      varchar(254),
    global_potfile_path     varchar(254),
    global_rules_index      integer         not null default 0,
    options                 varchar(254)    not null default 'status',
    attack_mode             integer         not null default 0,
    rule_debug              integer         not null default 4,
    outfile_format          integer         not null default 15,
    hash_mode               integer,
...
create table hashcat_host (
    id                      integer         not null auto_increment,
    hostid                  integer         not null default 0,
    hashcatid               integer         not null default 0,
    speed                   double          not null default 0,
    workload_profile        integer         not null default 2,
    sent_rules_index_start  integer         not null default 0,
    send_rules_index_stop   integer         not null default 0,
    sent_words_index_start  integer         not null default 0,
    sent_words_index_stop   integer         not null default 0,
...
create table hashcat_hash (
    id                      integer         not null auto_increment,
    hash                    varchar(254),
    recovered               tinyint(1)      not null default 0,
    password                varchar(254),
    recovering_rule         integer         not null default 0,
    recovering_word         integer         not null default 0,
    recovering_charset_hex  integer         not null default 0,
    hash_mode               integer,
    primary key (id)
) engine=InnoDB;

create table hashcat_rule (
    id                      integer         not null auto_increment,
    rule                    varchar(254),
    primary key (id)
) engine=InnoDB;

create table hashcat_word (
    id                      integer         not null auto_increment,
    word                    varchar(254),
    primary key (id)
) engine=InnoDB;

create table hashcat_charset_hex (
    id                      integer         not null auto_increment,
    charset_hex             varchar(254),
    primary key (id)
) engine=InnoDB;
